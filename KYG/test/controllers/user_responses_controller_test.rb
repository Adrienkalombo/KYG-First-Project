...
class UserResponsesControllerTest < ActionController::TestCase
  ...
  test "should create user_response" do
    assert_difference('UserResponse.count') do
      post :create, user_response: { capital: @user_response.capital, language: @user_response.language, question_id: @user_response.question_id }
    end
  ...
  test "should update user_response" do
    patch :update, id: @user_response, user_response: { capital: @user_response.capital, language: @user_response.language, question_id: @user_response.question_id }
    assert_redirected_to user_response_path(assigns(:user_response))
  end
